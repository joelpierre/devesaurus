...
class WPSEO_Utils {
	...
	/**
	 * Returns a base64 URL for the icons for use in the menu.
	 *
	 * @since 3.3.0
	 *
	...
	public static function traffic_light_svg() {
		return <<<SVG
<icons class="yst-traffic-light init" version="1.1" xmlns="http://www.w3.org/2000/icons"
