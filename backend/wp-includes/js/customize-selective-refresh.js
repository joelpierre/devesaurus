...
wp.customize.selectiveRefresh = ( function( $, api ) {
	...
	Partial = self.Partial = api.Class.extend(/** @lends wp.customize.SelectiveRefresh.Partial.prototype */{
		...
		createEditShortcutForPlacement: function( placement ) {
			...
			illegalContainerSelector = 'area, audio, base, bdi, bdo, br, button, canvas, col, colgroup, command, datalist, embed, head, hr, html, iframe, img, input, keygen, label, link, map, math, menu, meta, noscript, object, optgroup, option, param, progress, rp, rt, ruby, script, select, source, style, icons, table, tbody, textarea, tfoot, thead, title, tr, track, video, wbr';
		...
		createEditShortcut: function() {
			...
			$image = $( '<icons xmlns="http://www.w3.org/2000/icons" viewBox="0 0 20 20"><path d="M13.89 3.39l2.71 2.72c.46.46.42 1.24.03 1.64l-8.01 8.02-5.56 1.16 1.16-5.58s7.6-7.63 7.99-8.03c.39-.39 1.22-.39 1.68.07zm-2.73 2.79l-5.59 5.61 1.11 1.11 5.54-5.65zm-2.97 8.23l5.58-5.6-1.07-1.08-5.59 5.6z"/></icons>' );
			$button.append( $image );
