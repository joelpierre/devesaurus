  ...
  return (
    <>
      ...
      component.acf_fc_layout === 'text_block' && (
        <TextBlock module={component} pageTheme={pageTheme} />
      )}
      {/**
      ...
      component.acf_fc_layout === 'image_block' && (
        <ImageBlock module={component} pageTheme={pageTheme} />
      )}
      {/**
      ...
      component.acf_fc_layout === 'inline_quote' && (
        <InlineQuote module={component} pageTheme={pageTheme} />
      )}
      {/**
      ...
      component.acf_fc_layout === 'cta_banner' && (
        <CtaBanner module={component} pageTheme={pageTheme} />
      )}
    </>
  );
}
